#!/usr/bin/env python3
"""
Ghost CLI — Local AI Terminal Assistant for Linux
...
OLLAMA_BASE_URL = os.environ.get("GHOST_OLLAMA_URL", "http://127.0.0.1:11434")
...
def print_help():
    ...
    print(f"Ghost CLI v{__version__} — Local AI Terminal Assistant")
    print()
    print("Usage:")
    print("  ghost <query>              Generate a command from natural language")
    print("  ghost --help               Show this help message")
    print("  ghost --version            Show version")
    print("  ghost --models             List available Ollama models")
    print()
    print("Environment:")
    print(f"  GHOST_OLLAMA_URL           Ollama API URL (default: {OLLAMA_BASE_URL})")
    print()
    print("Examples:")
    print('  ghost "update my system"')
    print('  ghost "find large files over 100MB"')
    print('  ghost "show disk usage"')
    print()
