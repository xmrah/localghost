...
Thanks for your interest! LocalGhost is a small, focused project. Here's how to contribute.

## Philosophy

- **Zero external dependencies.** LocalGhost uses only Python 3 standard library. Do not add `pip` packages.
...
- **Bug reports:** If LocalGhost suggests a wrong command, open an issue with:
  - Your distro (`cat /etc/os-release`)
  - Model used (`localghost --models`)
  - Query and output
